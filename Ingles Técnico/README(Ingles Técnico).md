...
Palabras y conceptos aprendidos
    ...
    **wider → más amplio.
    Nuevo vocabulario seamlessly → de manera fluida, sin interrupciones, sin problemas visibles. near → cerca de, próximo a. rough guess → estimación aproximada enlarges → amplía, agranda, aumenta el tamaño. wave → onda.
